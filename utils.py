...
class Utils(object):
    ...
    def evaluate_rankings(self, ranking_path, qrels_folder, qrels_name):
        ...
        MAP = self.get_averaged_measure_score(ranking_path, qrels_folder + '/' + qrels_name + '.qrel', 'map')
        NDCG = self.get_averaged_measure_score(ranking_path, qrels_folder + '/' + qrels_name + '.qrel', 'ndcg_cut_100')
        P_10 = self.get_averaged_measure_score(ranking_path, qrels_folder + '/' + qrels_name + '.qrel', 'P_10')
